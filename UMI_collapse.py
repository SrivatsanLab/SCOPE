...
def collapse_UMIs(library_csv, output_file, output_plot):
    ...
    library = pd.read_csv(library_csv, header=None, sep="\t", names=["R1_full_bc", "R1_UMI", "SR", "R2_UMI", "R2_full_bc"])
    ...
    library.to_csv(output_file, index=False)
...
sys.argv[3]: distribution plot of barcode counts (output) .png
